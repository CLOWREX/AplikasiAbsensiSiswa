      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex flex-col">
          <div className="flex items-center gap-3 lg:hidden mb-2">
             <button onClick={onMenuOpen} className="p-3 min-w-[45px] min-h-[45px] flex items-center justify-center text-[#5dbcd2] bg-white rounded-xl shadow-sm border border-gray-100">
               <FiMenu size={20}/>
             </button>
...
const Home = ({ onMenuOpen }) => {
  ...
  const features = [
    { title: "Presence", description: "Record your attendance or submit a leave request.", buttonText: "Check In", path: "/presence", image: "https://cdn-icons-png.flaticon.com/512/3135/3135715.png" },
    { title: "History", description: "View your past attendance records.", buttonText: "View Records", path: "/history", image: "https://cdn-icons-png.flaticon.com/512/2693/2693507.png" },
    { title: "Schedule", description: "Check your daily timetable to stay on track.", buttonText: "Check Schedule", path: "/schedule", image: "https://cdn-icons-png.flaticon.com/512/1048/1048953.png" },
    { title: "Profile", description: "Keep your personal information up to date.", buttonText: "Open Profile", path: "/profile", image: "https://cdn-icons-png.flaticon.com/512/3135/3135768.png", accent: "bg-[#fdf2e9]/60" }
  ];

  if (loading) return <div className="h-screen w-full flex items-center justify-center bg-[#D6EBEE] text-[#5dbcd2] font-black">Loading...</div>;
