...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    ...
    { name: 'Presence', icon: <FiCheckSquare />, path: '/presence_teacher' },
    { name: "Register", icon: <FiUsers />, path: "/register_teacher" },
    { name: "Manage Data", icon: <FiFileText />, path: "/data_teacher" },
    { name: 'Profile', icon: <FiUser />, path: '/profile_teacher' },
    { name: 'Notification', icon: <FiBell />, path: '/notification_teacher' },
  ];
