...
const FeatureCard = ({ title, description, buttonText, image, accent }) => (
...
export default function Home() {
  ...
  const features = [
      ...
      { title: "Manage Data", description: "View and manage student attendance records.", buttonText: "Open Data", path: "/data_teacher", image: "https://cdn-icons-png.flaticon.com/512/1048/1048953.png" },
  ...
  return (
    <div className="flex min-h-screen bg-[#D6EBEE] font-['Afacad']">
      {/* Sidebar hanya muncul di mobile */}
